...
{\large Institut de Physique Nucléaire de Lyon\\ Stage effectué du 12/03/18 au 13/07/18 }\\[0.5cm]

{\large Rapport de Stage de M2}\\[0.5cm]

% Title
\rule{\linewidth}{0.5mm} \\[0.4cm]
{ \huge \bfseries Discrimination entre signal et bruit de fond dans des événements \textgamma+jet, enregistrés par l'expérience CMS auprès du LHC. \\[0.4cm] }
